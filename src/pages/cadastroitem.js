...
export default function Home() {
  return (
    <div className={styles.divprincipal}>
      <Head>
        <title>OnLIB | Cadastrar Items</title>
            ...
            <div className={styles.container}>
              ...
              <div className="card" style={{width: '100%', marginBottom: '10px', padding: '10px'}}>
                <div className={styles.titulocontainer}>
                  <h1 className={styles.tituloadd}>Adicione um novo item</h1>
                  <button type="button" className={styles.botaoadd}>Adicionar</button>
                </div>
              </div>
              ...
              <table className={styles.contenttable}>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-danger" style={{marginLeft: '5px'}}>
